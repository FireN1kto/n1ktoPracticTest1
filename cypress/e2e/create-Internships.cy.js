describe('Создание стажировки работодателем', () => {
    it('Создание стажировки', () => {
        cy.fixture('cypresssTest').then(data =>{
            ...
            cy.get('.vacancy-add-form-wrapper > .form > :nth-child(1) > .form__labels > .labels > :nth-child(1) > .form-control--responsive > .form-input--').type(data.internship_title)
            ...
            cy.get('.vacancy-add-form-wrapper > .form > :nth-child(1) > .form__labels > .labels > :nth-child(6) > .form-control > .form-area').type(data.internship_requirements)

            cy.get('.vacancy-add-form-wrapper > .form > :nth-child(1) > .form__labels > .labels > :nth-child(7) > .form-control > .form-area').type(data.internship_responsibilities)
